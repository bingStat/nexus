...
$payload = @{ id=$id; command="which code || find / -name code -type f -executable 2>/dev/null | grep bin/"; target_device="thinkcenter"; status="pending"; timeout_ms=30000 } | ConvertTo-Json -Compress
