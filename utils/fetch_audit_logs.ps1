...
$uri = "https://api.cloudflare.com/client/v4/accounts/$accountId/audit_logs?direction=desc&limit=50"
$r = Invoke-RestMethod -Uri $uri -Headers $headers -Method GET
$r.result | ConvertTo-Json -Depth 10 > C:\Users\Bing\aurora\Workstation\Nexus\audit.json
