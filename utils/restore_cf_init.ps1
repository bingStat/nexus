...
$sshCmd = "ssh -o StrictHostKeyChecking=no root@192.168.31.88 ""sed -i 's/tunnel run --loglevel debug/tunnel run/' /etc/init.d/cloudflared && /etc/init.d/cloudflared restart"""
