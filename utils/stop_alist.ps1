...
$sshCmd = "ssh -o StrictHostKeyChecking=no root@192.168.31.88 '/etc/init.d/alist stop; /etc/init.d/alist disable; killall alist 2>/dev/null; netstat -tulpn | grep 5244'"
