...
$payload = @{ id=$id; command="ssh -o StrictHostKeyChecking=no root@192.168.31.88 'cat /opt/nexus/n1_agent.sh 2>/dev/null || echo MISSING'"; target_device="thinkcenter"; status="pending"; timeout_ms=30000 } | ConvertTo-Json -Compress
