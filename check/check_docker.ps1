...
$payload = @{ id=$id; command="ssh -o StrictHostKeyChecking=no root@192.168.31.88 'docker --version && echo DOCKER_EXISTS'"; target_device="thinkcenter"; status="pending" } | ConvertTo-Json -Compress
