...
$payload = @{ id=$id; command="ip route; curl -s -I https://github.com/login/device/code -m 5"; target_device="thinkcenter"; status="pending"; timeout_ms=30000 } | ConvertTo-Json -Compress
