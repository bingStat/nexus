...
$payload = @{ id=$id; command="cat /tmp/code_tunnel.log; ps aux | grep code-tunnel"; target_device="thinkcenter"; status="pending"; timeout_ms=30000 } | ConvertTo-Json -Compress
