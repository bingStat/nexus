...
$sshCmd = "ssh -o StrictHostKeyChecking=no root@192.168.31.88 'sed -i \"s/tunnel run/tunnel run --loglevel debug/\" /etc/init.d/cloudflared && /etc/init.d/cloudflared restart'"
