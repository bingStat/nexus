...
# List all routes for the thinkcenter-host-tunnel
$uri = "https://api.cloudflare.com/client/v4/accounts/$accountId/cfd_tunnel/8ba09dab-f25a-4dea-b361-14dcaf35a389/routes"
